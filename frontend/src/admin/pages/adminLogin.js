...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const url = "http://localhost:5001/api/admin/adminLogin";
      ...
      if (res.token) {
        ...
        alert(res.message || "Админ нэвтрэхэд алдаа гарлаа.");
      }
    } catch (error) {
      ...
      if (error.response && error.response.status === 400) {
        ...
        alert("Админ нэвтрэхэд алдаа гарлаа. Дахин оролдоно уу.");
      }
    }
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <form
        ...
        className="w-full max-w-md bg-black p-6 shadow-lg rounded-lg"
      >
